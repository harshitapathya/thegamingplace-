...
class users extends CI_Controller{
	public function register(){
		...
		$this->form_validation->set_rules('username','Username','trim|required|min_length[4]|max_length[16]|is_unique[users.username]');
	...
	public function login(){
		...
		if($user_id){
			...
			redirect('products');
				...
				//Set error
				$this->session->set_flashdata('fail_login', 'Sorry,invalid user id/password');
				redirect('products');
			}
	}
